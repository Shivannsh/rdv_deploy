...
export default function Privacy() {
    return (
        <div style={{padding: 20}} className="privacy">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Rendezvous, Indian Institute of Technology Delhi, Hauz Khas, Delhi - 110016.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Rendezvous, accessible from <a href="https://www.rendezvousiitd.com" rel="external nofollow noopener" target="_blank">https://www.rendezvousiitd.com</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: <a href="mailto:rdvtech2023@gmail.com">rdvtech2023@gmail.com</a></li>
